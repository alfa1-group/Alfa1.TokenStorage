...
{
    public static IServiceCollection AddAuthenticationTokenStoragePostgreSQL(this IServiceCollection services, IConfiguration configuration,
    ...
    public static IServiceCollection AddAuthenticationTokenStoragePostgreSQLFor<TDependent>(this IServiceCollection services, IConfiguration configuration,
        ...
        where TDependent : class
    {
        ...
        services.AddKeyedAuthenticationTokenStoragePostgreSQL(typeof(TDependent), resolvedTokenIdentifier, configuration, dbContextLifetime);
    ...
    public static IServiceCollection AddAuthenticationTokenStoragePostgreSQLFor<TService, TImplementation>(this IServiceCollection services, IConfiguration configuration,
        ...
        where TImplementation : class, TService
    {
        ...
        services.AddKeyedAuthenticationTokenStoragePostgreSQL(typeof(TImplementation), resolvedTokenIdentifier, configuration, dbContextLifetime);
    ...
    public static IServiceCollection AddKeyedAuthenticationTokenStoragePostgreSQL(this IServiceCollection services, object serviceKey, string tokenIdentifier,
        IConfiguration configuration, ServiceLifetime dbContextLifetime = ServiceLifetime.Scoped)
    {
